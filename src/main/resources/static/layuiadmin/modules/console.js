    ...
    */
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , url: './static/layuiadmin/json/console/top-search.js' //模拟接口
            , page: true
            , cols: [[
        ...
        table.render({
            ...
            , url: './static/layuiadmin/json/console/top-card.js' //模拟接口
            , page: true
            , cellMinWidth: 120
            , cols: [[
                {type: 'numbers', fixed: 'left'}
        ...
        table.render({
            ...
            , url: './static/layuiadmin/json/console/prograss.js' //模拟接口
            , cols: [[
